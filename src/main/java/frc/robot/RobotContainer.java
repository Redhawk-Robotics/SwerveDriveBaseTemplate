...
private double getForwardInput() {
    return -square(deadband(DRIVER.getLeftY(), 0.1)) * DrivetrainSubsystem.MAX_VELOCITY_METERS_PER_SECOND;
}

private double getStrafeInput() {
    return -square(deadband(DRIVER.getLeftX(), 0.1)) * DrivetrainSubsystem.MAX_VELOCITY_METERS_PER_SECOND;
}

private double getRotationInput() {
    return -square(deadband(DRIVER.getRightX(), 0.1))
